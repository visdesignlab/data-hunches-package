...
export const handlePreviewOnClick = (ogDataSet: BarChartDataPoint[], labelToPreview: string, valueToPreview: number | undefined, svgHeight: number, svgWidth: number, containCategory: boolean, selectedDP: string | undefined) => {
