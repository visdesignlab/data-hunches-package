...
export var handlePreviewOnClick = function (ogDataSet, labelToPreview, valueToPreview, svgHeight, svgWidth, containCategory) {
    ...
    select('#rectangles-preview')
        ...
        .attr("fill", function (d) { return getRectFill(d, containCategory, labelToPreview, categoricalScale); });
    // make new data
