import { CategoricalColor, DarkBlue, LargeNumber, margin } from "../Interfaces/Constants";
...
export var getRectFill = function (d, doesContainCategory, selectedDP, categoricalScale) {
    return doesContainCategory ? (categoricalScale(d.categorical) || DarkBlue) : DarkBlue;
};
