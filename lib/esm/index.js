...
var BarChartWithDH = function () {
    ...
    return (_jsx(DataContext.Provider, __assign({ value: improvedDataSet }, { children: _jsxs("div", __assign({ style: { height: "calc(100vh - 64px)", width: '100vw' }, id: 'app-div' }, { children: [_jsx(TopBar, {}, void 0), _jsx(BarChart, { dataHunchArray: savedDH, retrieveData: retrieveData }, void 0), _jsx(WelcomeDialog, {}, void 0)] }), void 0) }), void 0));
};
