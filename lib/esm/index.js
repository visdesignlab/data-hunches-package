...
var BarChartWithDH = function () {
    ...
    var _a = useState(false), showTable = _a[0], setShowTable = _a[1];
    var makeShowTable = function (input) {
        setShowTable(input);
    };
    var _b = useState([]), improvedDataSet = _b[0], setImprovedDataSet = _b[1];
    useEffect(function () {
    ...
    return (_jsx(DataContext.Provider, __assign({ value: improvedDataSet }, { children: _jsxs("div", __assign({ style: { height: "calc(100vh - 64px)", width: '100vw' }, id: 'app-div' }, { children: [_jsx(TopBar, { showTable: showTable, makeShowTable: makeShowTable }, void 0), _jsxs(Grid, __assign({ container: true, style: { height: "calc(100vh - 64px)", width: '100vw' }, spacing: 1 }, { children: [_jsx(Grid, __assign({ item: true, xs: showTable ? 6 : 12, lg: showTable ? 6 : 12 }, { children: _jsx(BarChart, { dataHunchArray: savedDH, retrieveData: retrieveData, showTable: showTable }, void 0) }), void 0), showTable ? _jsx(Grid, __assign({ item: true, xs: 6, lg: 6 }, { children: _jsx(Table, { dataHunchArray: savedDH }, void 0) }), void 0) : _jsx(_Fragment, {}, void 0)] }), void 0), _jsx(WelcomeDialog, {}, void 0)] }), void 0) }), void 0));
};
