...
var BarChartWithDH = function (_a) {
    var datasetName = _a.datasetName, dataSet = _a.dataSet, svgWidth = _a.svgWidth, svgHeight = _a.svgHeight, datasetExplanation = _a.datasetExplanation;
    ...
    useEffect(function () {
        ...
        getDoc(doc(firebaseSetup, store.datasetName, "sub".concat(store.currentVol))).then(function (dhNextIndex) {
        ...
        getDocs(collection(firebaseSetup, store.datasetName, "sub".concat(store.currentVol), 'dhs')).then(function (dhResult) {
            store.setTotalDH(dhResult.size);
        });
    }, [store.currentVol]);
    useEffect(function () {
        // Retrieve saved DH from DB
        getDocs(collection(firebaseSetup, store.datasetName, "sub".concat(store.currentVol), 'dhs'))
            .then(function (result) { return __awaiter(void 0, void 0, void 0, function () {
            var tempDHArray, copyOfImpDataSet;
