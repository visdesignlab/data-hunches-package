...
var VolSelector = function () {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(ButtonGroup, __assign({ style: { paddingRight: '5px' } }, { children: [_jsx(Button, __assign({ size: 'small', variant: "outlined", onClick: handleDBMenu, color: "primary" }, { children: "Select Data" }), void 0), _jsx(Button, __assign({ size: 'small', variant: "outlined", onClick: handleVolMenu, color: "primary" }, { children: "Select Vol" }), void 0), _jsxs(Menu, __assign({ anchorEl: anchorVol, keepMounted: true, open: Boolean(anchorVol), onClose: handleClose }, { children: [subArray.map(function (d, i) {
