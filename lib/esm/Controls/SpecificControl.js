...
var SpecificControl = function () {
    ...
    return (_jsx("foreignObject", __assign({ id: 'specific-control', 
        ...
        display: 'none', width: ControlFOWidth, height: ControlFOHeight }, { children: _jsxs(Container, __assign({ className: styles.foreignObjectContainer }, { children: [_jsxs(ButtonGroup
                // ref={divRef}
                , __assign({ 
                    // ref={divRef}
                    orientation: "vertical", color: "primary", "aria-label": "vertical outlined primary button group" }, { children: [_jsx(Button, __assign({ onClick: annotationOnClickHandler }, { children: "Annotation" }), void 0), _jsx(Button, __assign({ onClick: manipulationOnClickHandler }, { children: "Direct Manipulation" }), void 0), _jsx(Button, __assign({ onClick: ratingClickHandler }, { children: "Rating" }), void 0), _jsx(Button, __assign({ onClick: dataSpaceClickHandler }, { children: "Data Space" }), void 0)] }), void 0), _jsx(IconButton, __assign({ size: "small", onClick: function () {
