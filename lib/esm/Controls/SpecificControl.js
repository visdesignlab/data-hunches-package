...
var SpecificControl = function () {
    ...
    return (_jsx("foreignObject", __assign({ id: 'specific-control', 
        ...
        display: 'none', width: ControlFOWidth, height: store.containCategory ? ControlFOHeight : WithoutCatControlFOHeight }, { children: _jsxs(Container, __assign({ className: styles.foreignObjectContainer }, { children: [_jsxs(ButtonGroup
                ...
                , __assign({ 
                    // ref={divRef}
                    orientation: "vertical", color: "primary", "aria-label": "vertical outlined primary button group" }, { children: [_jsx(Button, __assign({ onClick: annotationOnClickHandler }, { children: "Annotation" }), void 0), _jsx(Button, __assign({ onClick: rangeOnClickHandler }, { children: "Range" }), void 0), _jsx(Button, __assign({ onClick: manipulationOnClickHandler }, { children: "Manipulation" }), void 0), _jsx(Button, __assign({ onClick: ratingClickHandler }, { children: "Rating" }), void 0), _jsx(Button, __assign({ onClick: dataSpaceClickHandler }, { children: "Data Space" }), void 0), store.containCategory ? _jsx(Button, __assign({ onClick: categoricalClickHandler }, { children: "Categorical" }), void 0) : _jsx(_Fragment, {}, void 0)] }), void 0), _jsx(IconButton, __assign({ size: "small", onClick: function () {
