...
var SpecificControl = function () {
    ...
    return (_jsx("foreignObject", __assign({ id: 'specific-control', 
        ...
        display: 'none', width: ControlFOWidth, height: store.showCategory ? ControlFOHeight : WithoutCatControlFOHeight }, { children: _jsx(Container, __assign({ className: styles.specificControlContainer }, { children: _jsxs(ButtonGroup, __assign({ orientation: "vertical", color: "primary", "aria-label": "vertical outlined primary button group" }, { children: [_jsx(ContextButton, __assign({ onClick: function () {
                            ...
                            clickHandler('rating');
                        } }, { children: "Rating" }), void 0)] }), void 0) }), void 0) }), void 0));
};
