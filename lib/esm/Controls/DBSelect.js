...
var DBSelect = function () {
    ...
    return (_jsxs(ButtonGroup, __assign({ style: { paddingRight: '5px' } }, { children: [_jsx(Button, __assign({ size: 'small', variant: "outlined", onClick: handleMenu, color: "primary" }, { children: "Select Vol" }), void 0), _jsx(Menu, __assign({ id: "menu-appbar", anchorEl: anchorEl, keepMounted: true, open: open, onClose: handleClose }, { children: subArray.map(function (d) {
                    console.log(d);
                    return (_jsx(MenuItem, { children: d }, "SubItem".concat(d)));
                }) }), void 0)] }), void 0));
};
export default observer(DBSelect);
