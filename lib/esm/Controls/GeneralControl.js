...
var GeneralControl = function () {
    ...
    return (_jsx(Container, __assign({ style: { paddingTop: '5px' } }, { children: _jsxs(ButtonGroup, __assign({ color: "primary", "aria-label": "outlined primary button group", disabled: !store.userName }, { children: [_jsx(Button, __assign({ onClick: onClickAnnotation }, { children: "Add Annotations" }), void 0), _jsx(Button, __assign({ onClick: onClickIncExc }, { children: "Inclusion/Exclusion" }), void 0), _jsx(Button, __assign({ onClick: onClickSelectADataPoint }, { children: "Select a Data Point" }), void 0)] }), void 0) }), void 0));
};
