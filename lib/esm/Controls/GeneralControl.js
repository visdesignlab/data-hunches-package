...
var GeneralControl = function () {
    ...
    return (_jsx(Container, __assign({ style: { paddingTop: '5px' } }, { children: _jsxs(ButtonGroup, __assign({ color: "primary", "aria-label": "outlined primary button group" }, { children: [_jsx(Button, __assign({ onClick: onClickAnnotation }, { children: "Add Annotations" }), void 0), _jsx(Button, { children: "Inclusion/Exclusion" }, void 0), _jsx(Button, __assign({ onClick: onClickSelectADataPoint }, { children: "Select a Data Point" }), void 0)] }), void 0) }), void 0));
};
