...
var GeneralControl = function () {
    ...
    return (_jsx(_Fragment, { children: _jsxs(ButtonGroup, __assign({ color: "primary", "aria-label": "outlined primary button group", disabled: !store.userName, size: 'small', style: { marginLeft: '5px' } }, { children: [_jsx(NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('inclusion'); } }, { children: "Add New Value (Inclusion)" }), void 0), _jsx(NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('model'); } }, { children: "Transform Data" }), void 0), _jsx(NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('sketch'); } }, { children: "Add Sketch" }), void 0)] }), void 0) }, void 0));
};
