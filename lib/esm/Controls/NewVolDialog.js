...
var NewVolDialog = function (_a) {
    ...
    var confirmVol = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    attrRef = doc(firebaseSetup, store.datasetName, 'attr');
                    return [4 /*yield*/, getDoc(attrRef)];
                case 1:
                    attrResult = _a.sent();
                    if (!attrResult.exists()) return [3 /*break*/, 4];
                    numberOfSubs = attrResult.data().subs;
                    return [4 /*yield*/, updateDoc(doc(firebaseSetup, store.datasetName, 'attr'), {
                            subs: numberOfSubs + 1
                        })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, setDoc(doc(collection(firebaseSetup, store.datasetName), "sub".concat(numberOfSubs + 1)), { name: volName })];
                case 3:
                    _a.sent();
