...
var DemoOptionButtons = function (_a) {
    ...
    return (_jsxs(_Fragment, { children: [DataPreset[store.dbTag].categories.length > 0 ?
                ...
                _jsx(_Fragment, {}, void 0), _jsx(NonCapButton, __assign({ style: { marginRight: '5px', marginLeft: '5px' }, size: 'small', variant: 'outlined', color: store.showCategory ? 'primary' : 'default', onClick: function () {
                    makeShowTable(!showTable);
                } }, { children: showTable ? 'Hide Table' : 'Show Table' }), void 0), _jsxs(FormControl, __assign({ style: { marginRight: '5px', marginLeft: '5px' } }, { children: [_jsx(InputLabel, { children: "Select Data" }, void 0), _jsx(Select, __assign({ className: styles.inputSelect, native: true, value: store.dbTag, onChange: handleDBChange }, { children: Object.keys(DataPreset).map(function (d) {
