...
var DemoOptionButtons = function () {
    ...
    var _b = useState(null), anchorVol = _b[0], setAnchorVol = _b[1];
    var _c = useState(null), anchorDB = _c[0], setAnchorDB = _c[1];
    var _d = useState([]), subArray = _d[0], setSubArray = _d[1];
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(ButtonGroup, __assign({ style: { paddingRight: '5px' } }, { children: [_jsx(Button, __assign({ size: 'small', variant: "outlined", color: "primary", onClick: handleDBMenu }, { children: "Select Data" }), void 0), _jsx(Button, __assign({ size: 'small', variant: "outlined", onClick: handleVolMenu, color: "primary" }, { children: "Select Vol" }), void 0), DataPreset[store.dbTag].categories ?
                        _jsx(Button, __assign({ size: 'small', variant: 'outlined', color: store.showCategory ? 'primary' : 'default', onClick: function () {
                                store.setShowCategory(!store.showCategory);
                            } }, { children: "Show Category" }), void 0) :
                        _jsx(_Fragment, {}, void 0), _jsxs(Menu, __assign({ anchorEl: anchorVol, keepMounted: true, open: Boolean(anchorVol), onClose: handleClose }, { children: [subArray.map(function (d, i) {
                                return (_jsxs(MenuItem, __assign({ onClick: function () {
                                        store.setCurrentVol(i + 1);
                                        handleClose();
                                    } }, { children: [store.currentVol === (i + 1) ? '> ' : '', d] }), "SubItem".concat(d)));
                            }), _jsxs(MenuItem, __assign({ onClick: function () { sendDialogSignal(true); } }, { children: [_jsx(AddIcon, {}, void 0), "Start new volume"] }), void 0)] }), void 0), _jsx(Menu, __assign({ anchorEl: anchorDB, keepMounted: true, open: Boolean(anchorDB), onClose: handleClose }, { children: Object.keys(DataPreset).map(function (d) {
                            return (_jsx(MenuItem, __assign({ onClick: function () {
                                    store.setDBTag(d);
                                    handleClose();
                                } }, { children: DataPreset[d].name }), "SelectDB".concat(d)));
                        }) }), void 0)] }), void 0), _jsx(NewVolDialog, { open: openDialog, sendCloseSignal: sendDialogSignal }, void 0)] }, void 0));
};
