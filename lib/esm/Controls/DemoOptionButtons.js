...
var DemoOptionButtons = function () {
    ...
    return (_jsxs(_Fragment, { children: [DataPreset[store.dbTag].categories ?
                _jsx(NonCapButton, __assign({ size: 'small', variant: 'outlined', style: { paddingRight: '5px' }, color: store.showCategory ? 'primary' : 'default', onClick: function () {
                        store.setShowCategory(!store.showCategory);
                    } }, { children: "Show Category" }), void 0) :
                _jsx(_Fragment, {}, void 0), _jsxs(FormControl, __assign({ style: { paddingRight: '5px' } }, { children: [_jsx(InputLabel, { children: "Select Data" }, void 0), _jsx(Select, __assign({ className: styles.inputSelect, native: true, value: store.dbTag, onChange: handleDBChange }, { children: Object.keys(DataPreset).map(function (d) {
                            return (_jsx("option", __assign({ value: d }, { children: DataPreset[d].name }), "SelectDB".concat(d)));
                        }) }), void 0)] }), void 0), _jsxs(FormControl, __assign({ style: { paddingRight: '5px' } }, { children: [_jsx(InputLabel, { children: "Select Collection" }, void 0), _jsxs(Select, __assign({ className: styles.inputSelect, native: true, value: store.currentVol, onChange: handleVolChange }, { children: [subArray.map(function (d, i) {
