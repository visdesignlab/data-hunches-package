    ...
    return _jsxs("div", __assign({ style: { height: '100%' } }, { children: [_jsxs(ChartSVG, __assign({ ref: svgRef, onClick: function () {
                    if (store.selectingADataPoint) {
                        ...
                        store.setCurrentSelectedDP(undefined);
                            ...
                            return _jsx(BarElement, { dataElement: d, width: valueScale(d.value) - margin.left, height: bandScale.bandwidth(), xPos: margin.left, yPos: bandScale(d.label) || 0, fill: store.showCategory ? categoricalColorScale(d.categorical || 'a') : DefaultBar }, "".concat(i, "-barelement"));
                            ...
                            })] }), void 0), _jsx(RangeLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(SketchLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(FormComponent, {}, void 0), _jsx(SpecificControl, { sendManipulation: sendManipulationToParent }, void 0)] }), void 0), _jsxs(Grid, __assign({ container: true }, { children: [_jsxs(Grid, __assign({ item: true, xs: 6 }, { children: [(store.inputMode === 'sketch' ||
                                store.inputMode === 'direction' ||
                                store.inputMode === 'manipulations' ||
                                store.inputMode === 'range') ?
                                ...
                                _jsx(_Fragment, {}, void 0), _jsx(ChartTitle, {}, void 0)] }), void 0), _jsx(Grid, __assign({ item: true, xs: 6, style: { textAlign: 'start' } }, { children: _jsx("ul", __assign({ className: styles.noBulletsList }, { children: allChartDHArray.map(function (d, i) {
