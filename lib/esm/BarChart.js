...
var BarChart = function (_a) {
    ...
    return (_jsxs("div", __assign({ style: { height: '100%' } }, { children: [_jsxs(ChartSVG, __assign({ ref: svgRef, onClick: function () {
                    if (store.selectingADataPoint) {
                        ...
                        store.setCurrentSelectedDP(undefined);
                            ...
                            })] }), void 0), _jsx(RangeLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(SketchLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(FormComponent, {}, void 0), _jsx(SpecificControl, { sendManipulation: sendManipulationToParent }, void 0)] }), void 0), _jsxs(Container, { children: [(store.inputMode === 'sketch' ||
                        store.inputMode === 'direction' ||
                        store.inputMode === 'manipulations' ||
                        store.inputMode === 'range') ?
