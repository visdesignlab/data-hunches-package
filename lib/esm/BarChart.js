...
var BarChart = function (_a) {
    ...
    return (_jsxs("div", __assign({ style: { height: '100%' }, id: 'app-div' }, { children: [_jsxs(ChartSVG, __assign({ ref: svgRef, onClick: function () {
                    ...
                    if (store.votingDH) {
                        store.setVotingDH(undefined);
                            ...
                            })] }), void 0), _jsx(RangeLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(SketchLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(FormComponent, {}, void 0), _jsx(SpecificControl, { sendManipulation: sendManipulationToParent }, void 0), _jsx("foreignObject", __assign({ display: 'none', id: "upvote-downvote-FO", width: UpDownVoteFOWidth, height: UpDownVoteFOHeight, className: styles.foreignObjectContainer }, { children: _jsx(UpvotesDownvotes, { retrieveData: retrieveData, idAssignment: '' }, void 0) }), void 0)] }), void 0), _jsxs(Container, { children: [(store.inputMode === 'sketch' ||
                        store.inputMode === 'direction' ||
                        store.inputMode === 'manipulations' ||
                        store.inputMode === 'range') ?
                        _jsx("div", __assign({ style: { width: DefaultForeignObjectWidth, height: DefaultForeignObjectHeight } }, { children: _jsx(ManipulationForm, { manipulationOutput: manipulationResult, type: store.inputMode }, void 0) }), void 0) :
                        _jsx(_Fragment, {}, void 0), _jsx(ChartTitle, {}, void 0)] }, void 0), _jsx(ContainerDiv, { children: _jsx("ul", __assign({ className: styles.noBulletsList }, { children: allChartDHArray.map(function (d) {
                    ...
                    }) }), void 0) }, void 0), _jsx(UpvotesDownvotes, { retrieveData: retrieveData, idAssignment: "upvote-downvote" }, void 0)] }), void 0));
};
