...
var BarChart = function (_a) {
    ...
    return _jsxs("div", { children: [_jsxs("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [_jsx(ChartLegends, {}, void 0), _jsx("g", { className: 'axis', id: "band-axis" }, void 0), _jsx("g", __assign({ id: "rectangles-preview", display: store.needToShowPreview ? undefined : 'none' }, { children: _jsx("g", { className: 'axis', id: "axis-mask", transform: "translate(".concat(margin.left, ",0)") }, void 0) }), void 0), _jsx("g", { className: 'axis', id: "vertical-axis" }, void 0), _jsx("g", __assign({ id: "rectangles", display: (!store.needToShowPreview) ? undefined : 'none' }, { children: dataSet.map(function (d, i) {
                            return _jsx(BarElement, { dataElement: d, width: valueScale(d.value) - margin.left, height: bandScale.bandwidth(), xPos: margin.left, yPos: bandScale(d.label) || 0, fill: store.containCategory.length > 0 ? categoricalColorScale(d.categorical || 'a') : DefaultBar }, "".concat(i, "-barelement"));
                            ...
                            if (barDP.dataHunchArray) {
                                ...
                                return (_jsx(LightTooltip, __assign({ title: _jsxs("div", { children: [d.type !== 'sketch' ? _jsxs("div", { children: ["Content: ", d.content] }, void 0) : _jsx(_Fragment, {}, void 0), _jsxs("div", { children: ["Reasoning: ", d.reasoning] }, void 0)] }, void 0) }, { children: _jsx("li", __assign({ style: { width: 'fit-content' } }, { children: _jsxs(DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, isSelected: store.selectedDH.includes(d.id), onClick: function () { store.setSelectedDH([d.id]); }, onMouseOver: function () { store.setHighlightedDH(d.id); }, onMouseOut: function () { store.setHighlightedDH(-1); }, fontSize: 'larger', needBold: true, style: { textOverflow: 'ellipsis' } }, { children: ["*", d.type === 'sketch' ? 'sketch' : d.content] }), "".concat(d.id, "-text")) }), void 0) }), void 0));
