...
var BarChart = function (_a) {
    ...
    return _jsxs("div", { children: [_jsxs("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [_jsx(ChartLegends, {}, void 0), _jsxs("g", __assign({ id: 'chart-title' }, { children: [_jsx(Tooltip, __assign({ title: datasetExplanation }, { children: _jsxs("text", __assign({ x: store.svgWidth * 0.5, y: store.svgHeight - margin.bottom, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: [store.datasetName, datasetExplanation.length > 0 ? '*' : ''] }), void 0) }), void 0), allChartDHArray.map(function (d, i) {
                        ...
                        }) }), void 0), store.inputMode === 'range' ? _jsx(RangeLayer, { sendManipulation: sendManipulationToParent }, void 0) : _jsx(_Fragment, {}, void 0), store.inputMode === 'manipulations' ? _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0) : _jsx(_Fragment, {}, void 0), store.inputMode === 'sketch' ?
