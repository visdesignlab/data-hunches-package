...
var BarChart = function (_a) {
    ...
    return _jsxs("div", { children: [_jsxs("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [_jsx(ChartLegends, {}, void 0), _jsxs("g", __assign({ id: 'chart-title' }, { children: [_jsx("text", __assign({ x: store.svgWidth * 0.5, y: store.svgHeight - margin.bottom, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                                return (_jsx(Tooltip, __assign({ title: d.reasoning }, { children: _jsx(DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, x: (store.svgWidth - margin.left - margin.right) / 2 * (i % 2), y: store.svgHeight - margin.bottom + 30 + Math.floor(i / 2) * (IndicatorSpace + IndicatorSize), fontSize: 'larger' }, { children: "* ".concat(d.content.length > 30 ? "".concat(d.content.slice(0, 30), "...") : d.content) }), "".concat(d.id, "-text")) }), void 0));
