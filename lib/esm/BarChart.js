...
var BarChart = function (_a) {
    ...
    return (_jsxs("div", __assign({ style: { height: '100%' }, id: 'app-div', onClick: function () {
            if (store.votingDH) {
                store.setVotingDH(undefined);
            }
        } }, { children: [_jsxs(ChartSVG, __assign({ ref: svgRef, onClick: function () {
                    ...
                    // }
                            ...
                            })] }), void 0), _jsx(RangeLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(SketchLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(SpecificControl, { sendManipulation: sendManipulationToParent }, void 0)] }), void 0), _jsx(Container, { children: _jsx(ChartTitle, {}, void 0) }, void 0), _jsx(ContainerDiv, { children: _jsx("ul", __assign({ className: styles.noBulletsList }, { children: allChartDHArray.map(function (d) {
                    ...
                    }) }), void 0) }, void 0), _jsx(UpvotesDownvotes, { retrieveData: retrieveData }, void 0), _jsx(FormComponent, {}, void 0)] }), void 0));
};
