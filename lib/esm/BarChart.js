    ...
    return (_jsxs("div", __assign({ style: { height: '100%' }, onClick: function () {
            ...
            if (store.selectingADataPoint) {
                ...
                store.setCurrentSelectedDP(undefined);
                            ...
                            })] }), void 0), _jsx(RangeLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0), _jsx(SketchLayer, { sendManipulation: sendManipulationToParent }, void 0)] }), void 0), _jsx(ChartTitle, {}, void 0), _jsx(ContainerDiv, { children: _jsx("ul", __assign({ className: styles.noBulletsList }, { children: allChartDHArray.map(function (d) {
