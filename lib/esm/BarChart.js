    ...
    return (_jsxs("div", __assign({ style: { height: '100%' }, onClick: function () {
            ...
            if (store.selectingADataPoint) {
                ...
                store.setCurrentSelectedDP(undefined);
                        ...
                        }) }), void 0), _jsx("g", { id: 'categorical-preview' }, void 0), _jsxs("g", __assign({ id: 'data-hunches-container' }, { children: [sketchArray.map(function (sketchDP) {
                        ...
                        return (_jsx(StyledTooltip, { dataHunch: d, childrenComponent: _jsx("li", __assign({ style: { width: 'fit-content' } }, { children: _jsxs(DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, isSelected: store.selectedDH.includes(d.id), onClick: function () { store.setSelectedDH([d.id]); }, onContextMenu: function (e) {
                                        ...
                                        store.setVotingDH(d);
                                    }, onMouseOver: function () { store.setHighlightedDH(d.id); }, onMouseOut: function () { store.setHighlightedDH(-1); }, fontSize: 'larger', needBold: true, style: { textOverflow: 'ellipsis' } }, { children: ["*", d.type === 'sketch' ? 'sketch' : d.content, d.upvotes > 0 ?
                                            _jsxs(_Fragment, { children: [" ", _jsx("i", { className: "fa-solid fa-thumbs-up" }, void 0), d.upvotes] }, void 0)
                                            : _jsx(_Fragment, {}, void 0), d.downvotes > 0 ?
                                            _jsxs(_Fragment, { children: [" ", _jsx("i", { className: "fa-solid fa-thumbs-down" }, void 0), d.downvotes] }, void 0)
                                            : _jsx(_Fragment, {}, void 0)] }), void 0) }), "".concat(d.id, "-text")) }, void 0));
