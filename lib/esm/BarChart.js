...
var BarChart = function (_a) {
    ...
    return _jsxs("div", { children: [_jsx(GeneralControl, {}, void 0), _jsxs("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [_jsxs("g", __assign({ id: 'chart-title' }, { children: [_jsx("text", __assign({ x: store.svgWidth * 0.5, y: 5, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                                return (_jsx(Tooltip, __assign({ title: d.content }, { children: _jsx(DHIndicatorText, __assign({ x: findStart() + IndicatorSize * (i) * 2 + IndicatorSpace * i, y: 34, fontSize: 'large' }, { children: "*" }), d.id) }), d.id));
                            })] }), void 0), _jsx("g", { className: 'axis', id: "band-axis" }, void 0), _jsx("g", __assign({ id: "rectangles-preview", display: (store.inputMode === 'dataSpace' || store.needToShowPreview) ? undefined : 'none' }, { children: _jsx("g", { className: 'axis', id: "axis-mask", transform: "translate(".concat(margin.left, ",0)") }, void 0) }), void 0), _jsx("g", { className: 'axis', id: "vertical-axis" }, void 0), _jsx("g", __assign({ id: "rectangles", display: (store.inputMode !== 'dataSpace' && !store.needToShowPreview) ? undefined : 'none' }, { children: dataSet.map(function (d, i) {
                        ...
                        }) }), void 0), _jsx("g", __assign({ id: 'data-hunches-container' }, { children: dataSet.map(function (d) {
                            if (d.dataHunchArray) {
