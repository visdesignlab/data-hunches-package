...
var BarChart = function (_a) {
    ...
    return _jsxs("div", { children: [_jsx(GeneralControl, {}, void 0), _jsxs("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [_jsx(ChartLegends, {}, void 0), _jsxs("g", __assign({ id: 'chart-title' }, { children: [_jsx("text", __assign({ x: store.svgWidth * 0.5, y: 5, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                                return (_jsx(Tooltip, __assign({ title: d.content }, { children: _jsx(DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, x: findStart() + IndicatorSize * (i) * 2 + IndicatorSpace * i, y: 34, fontSize: 'large' }, { children: "*" }), "".concat(d.id, "-text")) }), void 0));
                            ...
                            return _jsx(BarElement, { dataElement: d, height: store.svgHeight - margin.bottom - verticalValueScale(d.value), width: honrizontalBandScale.bandwidth(), xPos: honrizontalBandScale(d.label) || 0, yPos: verticalValueScale(d.value), fill: store.containCategory.length > 0 ? categoricalColorScale(d.categorical || 'a') : DarkBlue }, "".concat(i, "-barelement"));
                            ...
                            if (barDP.dataHunchArray) {
                                ...
                                if (store.selectedDH.length === 0) {
                                    ...
                                    return (_jsxs(_Fragment, { children: [_jsx(DataHunchIndicator, { dataHunchArray: barDP.dataHunchArray.filter(function (d) { return ["annotation", 'exclusion', 'categorical'].includes(d.type) || store.selectedDH.includes(d.id); }) }, "".concat(barDP.label, "-dhindicator")), _jsx(CategoricalIndicator, { dataHunchArrayString: JSON.stringify(catDH.filter(function (d) { return store.selectedDH.includes(d.id); })) }, "".concat(barDP.label, "-catindicator"))] }, void 0));
                                }
                            }
                            else {
                                return _jsx(_Fragment, {}, void 0);
                            }
                        }) }), void 0), store.inputMode === 'manipulations' ? _jsx(ManipulationLayer, { sendManipulation: sendManipulationToParent }, void 0) : _jsx(_Fragment, {}, void 0), store.inputMode === 'sketch' ?
                        _jsx(SketchLayer, { sendManipulation: sendManipulationToParent }, void 0) : _jsx(_Fragment, {}, void 0), _jsx(FormComponent, { manipulationOutput: manipulationResult }, void 0), _jsx(SpecificControl, {}, void 0)] }), void 0), _jsx("div", __assign({ style: { width: DefaultForeignObjectWidth, height: DefaultForeignObjectHeight } }, { children: store.inputMode === 'sketch' ?
                    _jsx(ManipulationForm, { manipulationOutput: manipulationResult, type: 'sketch' }, void 0) : _jsx(_Fragment, {}, void 0) }), void 0)] }, void 0);
};
