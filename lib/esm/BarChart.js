...
var BarChart = function () {
    ...
    select('#band-axis')
        ...
        .call(xAxis);
    return _jsxs("div", { children: [_jsx(GeneralControl, {}, void 0), _jsxs("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [_jsx("g", { className: 'axis', id: "band-axis" }, void 0), _jsx("g", { className: 'axis', id: "axis-mask", transform: "translate(".concat(margin.left, ",0)") }, void 0), _jsx("g", { className: 'axis', id: "vertical-axis" }, void 0), _jsx("g", { id: "rectangles-preview", display: store.inputMode === 'dataSpace' ? undefined : 'none' }, void 0), _jsx("g", __assign({ id: "rectangles", display: store.inputMode !== 'dataSpace' ? undefined : 'none' }, { children: dataSet.map(function (d, i) {
