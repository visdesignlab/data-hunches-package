...
var PreviewResetButtons = function (_a) {
    ...
    var previewHandler = function () {
        handlePreviewOnClick(dataSet, labelToPreview, valueToPreview, store.svgHeight, store.svgWidth, store.containCategory, store.selectedDP);
    };
...
export var handlePreviewOnClick = function (ogDataSet, labelToPreview, valueToPreview, svgHeight, svgWidth, containCategory, selectedDP) {
    ...
    select('#rectangles-preview')
        ...
        .attr("fill", function (d) { return getRectFill(d, containCategory, selectedDP, categoricalScale); });
    // make new data
...
export var handleResetOnClick = function (ogDataSet, svgHeight, svgWidth, containCategory, selectedDP) {
    var verticalScale = makeVerticalScale(ogDataSet, svgHeight);
    var bandScale = makeBandScale(ogDataSet, svgWidth);
    var categoricalScale = makeCategoricalScale(ogDataSet);
