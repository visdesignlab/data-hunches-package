...
var RatingForm = function () {
    ...
    return (_jsxs(Container, __assign({ className: styles.foreignObjectContainer }, { children: [_jsxs(RadioGroup, __assign({ name: "Rating", onChange: handleRadioChange }, { children: [_jsx(FormControlLabel, { value: "1", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: "\u2605" }, void 0), _jsx(FormControlLabel, { value: "2", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: "\u2605\u2605" }, void 0), _jsx(FormControlLabel, { value: "3", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: "\u2605\u2605\u2605" }, void 0), _jsx(FormControlLabel, { value: "4", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: "\u2605\u2605\u2605\u2605" }, void 0), _jsx(FormControlLabel, { value: "5", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: "\u2605\u2605\u2605\u2605\u2605" }, void 0)] }), void 0), _jsx(TextField, { required: true, label: "Reason", multiline: true, rows: 3, size: "small", onChange: handleReasonChange, placeholder: "Enter reason for the data hunch", variant: "outlined", style: { paddingTop: '5px', paddingBottom: '5px' } }, void 0), _jsx(SubmitCancelButtons, { disableSubmit: !ratingValue || reasonInput.length === 0, dhToSubmit: {
                    type: 'rating',
                    user: store.userName,
