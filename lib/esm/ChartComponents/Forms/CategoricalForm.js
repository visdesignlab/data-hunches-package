...
var CategoricalForm = function () {
    ...
    return (_jsxs(Container, __assign({ className: styles.foreignObjectContainer }, { children: [_jsx(RadioGroup, __assign({ name: "Rating", onChange: handleRadioChange, value: ratingValue }, { children: store.containCategory.map(function (d, i) {
                    return _jsx(FormControlLabel, { value: d, control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: _jsxs("div", __assign({ className: styles.catText }, { children: [_jsx("div", { className: styles.colorBox, style: { backgroundColor: CategoricalColor[i] } }, void 0), d, catNum === i ? '(Original category)' : ''] }), void 0) }, "".concat(d, "-radio"));
