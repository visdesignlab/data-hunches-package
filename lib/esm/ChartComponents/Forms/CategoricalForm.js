...
var CategoricalForm = function () {
    ...
    return (_jsxs(Container, __assign({ className: styles.foreignObjectContainer }, { children: [_jsxs(RadioGroup, __assign({ name: "Rating", onChange: handleRadioChange, value: ratingValue }, { children: [_jsx(FormControlLabel, { value: "Cat0", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: _jsxs("div", __assign({ className: styles.catText }, { children: [_jsx("div", { className: styles.colorBox, style: { backgroundColor: CategoricalColor[0] } }, void 0), catNum === 0 ? 'Original category' : ''] }), void 0) }, void 0), _jsx(FormControlLabel, { value: "Cat1", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: _jsxs("div", __assign({ className: styles.catText }, { children: [_jsx("div", { className: styles.colorBox, style: { backgroundColor: CategoricalColor[1] } }, void 0), catNum === 1 ? 'Original category' : ''] }), void 0) }, void 0), _jsx(FormControlLabel, { value: "Cat2", control: _jsx(Radio, { size: "small", className: styles.radioStyle }, void 0), label: _jsxs("div", __assign({ className: styles.catText }, { children: [_jsx("div", { className: styles.colorBox, style: { backgroundColor: CategoricalColor[2] } }, void 0), catNum === 2 ? 'Original category' : ''] }), void 0) }, void 0)] }), void 0), _jsx(ReasonConfidenceInput, { updateConfidenceReason: sendConfidenceReasonToParent }, void 0), _jsx(SubmitCancelButtons, { disableSubmit: !ratingValue || reasonInput.length === 0, dhToSubmit: {
                    type: 'categorical',
                    user: store.userName,
