...
var SubmitCancelButtons = function (_a) {
    ...
    return _jsxs(ButtonGroup, { children: [_jsx(NonCapButton, __assign({ size: 'small', onClick: submitClickHandler, disabled: disableSubmit }, { children: "Submit" }), void 0), _jsx(NonCapButton, __assign({ size: 'small', onClick: cancelClickHandler, variant: 'outlined' }, { children: "Cancel" }), void 0)] }, void 0);
};
