...
var BarElement = function (_a) {
    ...
    return _jsx("rect", { width: width, height: height, x: xPos, y: yPos, cursor: store.selectingADataPoint ? 'pointer' : undefined, onClick: barElementOnClick, onMouseLeave: function () { store.setHighlightedDH(-1); }, fill: store.selectedDP === dataElement.label ? BrightOrange : fill }, void 0);
};
