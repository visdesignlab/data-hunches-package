...
var BarElement = function (_a) {
    ...
    return _jsx("rect", { width: width, height: height, x: xPos, y: yPos, cursor: store.userName ? 'pointer' : undefined, onContextMenu: barElementOnClick, onClick: function (e) { barElementOnClick(e, true); }, 
