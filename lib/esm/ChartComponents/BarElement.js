...
var BarElement = function (_a) {
    ...
    return _jsx("rect", { width: width, height: height, x: xPos, y: yPos, cursor: store.selectingADataPoint ? 'pointer' : undefined, onClick: barElementOnClick, onMouseLeave: function () { store.setHighlightedDH(-1); store.setSelectedDH([]); }, fill: fill, strokeWidth: 4, stroke: store.selectedDP === dataElement.label ? BrightOrange : 'none' }, void 0);
};
