...
var FormComponent = function (_a) {
    ...
    return (_jsx("foreignObject", __assign({ id: 'form-component', display: !['none', 'manipulations', 'sketch'].includes(store.inputMode) ? undefined : 'none', width: DefaultForeignObjectWidth, height: DefaultForeignObjectHeight }, { children: formContent[store.inputMode] }), void 0));
};
