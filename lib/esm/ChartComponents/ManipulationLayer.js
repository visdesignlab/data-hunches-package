...
var ManipulationLayer = function (_a) {
    ...
    return (_jsxs("g", __assign({ display: store.inputMode === 'manipulations' ? undefined : 'none' }, { children: [_jsx("g", { id: 'result-rect', ref: resultRef }, void 0), _jsx("rect", { id: 'drag-rect', x: margin.left, 
