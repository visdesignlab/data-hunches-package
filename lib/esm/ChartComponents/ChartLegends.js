...
var ChartLegends = function () {
    ...
    return (_jsx("g", { children: store.containCategory.map(function (cat, i) {
            return (_jsxs(_Fragment, { children: [_jsx("circle", { fill: categoricalColorScale(cat), cx: store.svgWidth - IndicatorSize * 2, cy: IndicatorSize + 2 + (IndicatorSize + 2) * i * 2, r: IndicatorSize }, void 0), _jsx("text", __assign({ x: store.svgWidth - IndicatorSize * 4, y: IndicatorSize + 2 + (IndicatorSize + 2) * i * 2, alignmentBaseline: 'central', textAnchor: 'end' }, { children: cat }), void 0)] }, void 0));
        }) }, void 0));
};
