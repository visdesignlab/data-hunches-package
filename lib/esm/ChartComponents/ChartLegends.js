...
var ChartLegends = function () {
    ...
    return (_jsx("g", __assign({ transform: "translate(0,".concat(store.svgHeight - (IndicatorSize + 2 + (IndicatorSize + 2) * DataPreset[store.dbTag].categories.length * 2), ")") }, { children: DataPreset[store.dbTag].categories.map(function (cat, i) {
