...
var ChartLegends = function () {
    ...
    var wrap = textwrap().bounds({ width: 80, height: (IndicatorSize + 2) * 5 }).method('tspans');
    ...
    return (_jsx("g", __assign({ transform: "translate(0,10)", ref: legendRef }, { children: DataPreset[store.dbTag].categories.map(function (cat, i) {
            return (_jsxs("g", { children: [_jsx("circle", { fill: categoricalColorScale(cat), cx: store.svgWidth - IndicatorSize * 2 - 80, cy: IndicatorSize + 2 + (IndicatorSize + 2) * i * 4, r: IndicatorSize }, void 0), _jsx("text", __assign({ x: store.svgWidth - 80, y: IndicatorSize + 2 + (IndicatorSize + 2) * i * 4, alignmentBaseline: 'central', textAnchor: 'start' }, { children: cat }), void 0)] }, "".concat(cat, "-legend")));
        }) }), void 0));
};
