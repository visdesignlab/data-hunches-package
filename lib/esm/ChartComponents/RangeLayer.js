...
var RangeLayer = function (_a) {
    ...
    var sketchyOption = __assign(__assign({}, DefaultSketchyOptions), { fill: BrightOrange, stroke: BrightOrange });
    ...
    return (_jsxs("g", __assign({ display: store.inputMode === 'manipulations' ? undefined : 'none' }, { children: [_jsx("g", { id: 'result-rect', ref: resultRef }, void 0), _jsx("rect", { id: 'drag-rect', x: margin.left, y: (bandScale(store.selectedDP || '') || 0) - 50, width: store.svgWidth - margin.left - margin.right, height: bandScale.bandwidth() + 100, opacity: 0.4, fill: LightGray, onMouseLeave: function () { setIsMouseDown(false); }, onMouseUp: mouseUpHandler, onMouseDown: mouseDownHandler, onMouseMove: dragHandler }, void 0)] }), void 0));
};
