...
var SingleOverAxisIndicator = function (_a) {
    ...
    return (_jsx(Tooltip, __assign({ title: dataHunch.reasoning }, { children: _jsxs("g", __assign({ cursor: "pointer", onClick: function () { store.setSelectedDH([dataHunch.id]); }, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); } }, { children: [_jsx("g", { ref: curveRef }, void 0), _jsx("text", __assign({ textAnchor: "middle", alignmentBaseline: "hanging", fill: highlighted ? HighlightColor : (selected ? SelectionColor : DarkGray), x: textX, y: textY, fontFamily: "'Nanum Brush Script', cursive", fontWeight: "bold" }, { children: dataHunch.content }), void 0)] }), void 0) }), void 0));
};
