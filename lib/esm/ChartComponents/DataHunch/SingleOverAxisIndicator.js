...
var SingleOverAxisIndicator = function (_a) {
    ...
    return (_jsx(StyledTooltip, { childrenComponent: _jsxs("g", { children: [dataHunch.upvotes + dataHunch.downvotes > 0 ? _jsx(ShowUpvotesDownvotes, { xPos: JSON.parse(curvePoints)[1][0] - 20, yPos: JSON.parse(curvePoints)[1][1] - 20, dataHunch: dataHunch }, void 0) : _jsx(_Fragment, {}, void 0), _jsxs("g", __assign({ cursor: "pointer", onClick: function () { store.setSelectedDH([dataHunch.id]); }, onContextMenu: function (e) {
                        toVoteDH(e, store.svgWidth, store.svgHeight);
                        store.setVotingDH(dataHunch);
                    }, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); } }, { children: [_jsx("g", { ref: curveRef }, void 0), _jsx("g", { ref: arrowRef, transform: "rotate(45,".concat(rotateX, ",").concat(rotateY, ")") }, void 0), _jsx("text", __assign({ textAnchor: "start", alignmentBaseline: "hanging", fill: highlighted ? HighlightColor : (selected ? SelectionColor : DataHunchColor), x: textX - 4, y: textY, fontFamily: "'Nanum Brush Script', cursive", fontWeight: "bold" }, { children: format('.2s')(parseInt(dataHunch.content)) }), void 0)] }), void 0)] }, void 0), dataHunch: dataHunch }, void 0));
};
