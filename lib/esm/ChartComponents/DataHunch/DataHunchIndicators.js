...
var DataHunchIndicator = function (_a) {
    ...
    var verticalValueScale = makeValueScale(dataSet, store.svgHeight);
    ...
    return (_jsxs("g", { children: [inVisDH.map(function (d, i) {
                ...
                if (inVisDH.length > 3) {
                    return (_jsx(DHIndicatorRect, { dataHunch: d, xPos: honrizontalBandScale(d.label) || 0, width: honrizontalBandScale.bandwidth(), yPos: calculateY(d, true) }, "".concat(d.id, "-dhindicatorRect")));
                }
                else {
