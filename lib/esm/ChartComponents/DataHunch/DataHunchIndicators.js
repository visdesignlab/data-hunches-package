...
var DataHunchIndicator = function (_a) {
    ...
    return (_jsxs("g", { children: [dataHunchDictionary.dataSpace.map(function (d, i) {
                ...
                _jsxs("g", { children: [_jsx("text", __assign({ x: valueScale(dataPoint.value) + 13, y: (bandScale(dataPoint.label) || 0) + 0.6 * bandScale.bandwidth(), textAnchor: "middle", fontSize: "small", alignmentBaseline: "middle" }, { children: dataPoint.value.toFixed(0) }), void 0), dataHunchDictionary.aboveAxis.map(function (dataHunch, i) {
                ...
                return (_jsx(StyledTooltip, { childrenComponent: _jsx("g", { children: _jsxs(DHIndicatorText, __assign({ x: findXPos(d, i, arrayLength), y: findYPos(i), fontSize: 'larger', needBold: false, isHighlighted: d.id === store.highlightedDH, isSelected: store.selectedDH.includes(d.id), onClick: function () { store.setSelectedDH([d.id]); }, onMouseOver: function () { store.setHighlightedDH(d.id); }, onContextMenu: function (e) {
                                toVoteDH(e, store.svgWidth, store.svgHeight);
                                store.setVotingDH(d);
                            }, onMouseOut: function () { store.setHighlightedDH(-1); } }, { children: [calculateText(d.content, findXPos(d, i, arrayLength), arrayLength, d.type), d.upvotes > 0 ? _jsxs(_Fragment, { children: [_jsx("tspan", __assign({ className: "fa-solid", fontSize: 'small' }, { children: " \uF164" }), void 0), d.upvotes] }, void 0) : '', d.downvotes > 0 ? _jsxs(_Fragment, { children: [_jsx("tspan", __assign({ className: "fa-solid", fontSize: 'small' }, { children: " \uF165" }), void 0), d.downvotes] }, void 0) : ''] }), void 0) }, void 0), dataHunch: d }, "".concat(d.id, "-text")));
