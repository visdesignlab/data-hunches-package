...
var DataHunchIndicator = function (_a) {
    ...
    var _f = useState([]), directionDH = _f[0], setDirectionDH = _f[1];
    useEffect(function () {
        var tempInVis = [];
        var tempOffVis = [];
        var tempExDH = [];
    ...
    return (_jsxs("g", { children: [inVisDH.map(function (d, i) {
                ...
                return (_jsx(SketchyDirection, { dataHunch: d, highlighted: d.id === store.highlightedDH, selected: store.selectedDH.includes(d.id), xPos: valueScale(dataPoint.value), yPos: (bandScale(dataPoint.label) || 0) + bandScale.bandwidth() / directionDH.length * (i + 0.5) }, "sketchy-".concat(d.id)));
                ...
                return (_jsx(StyledTooltip, { childrenComponent: _jsx(DHIndicatorText, __assign({ x: findXPos(d, i, offVisDH.length), y: (bandScale(d.label) || 0) + 0.5 * bandScale.bandwidth() + (2 * IndicatorSize) * (i % 2 === 0 ? -1 : 1), fontSize: 'larger', needBold: false, isHighlighted: d.id === store.highlightedDH, isSelected: store.selectedDH.includes(d.id), onClick: function () { store.setSelectedDH([d.id]); }, onMouseOver: function () { store.setHighlightedDH(d.id); }, onContextMenu: function (e) {
                            ...
                            store.setVotingDH(d);
                        }, onMouseOut: function () { store.setHighlightedDH(-1); } }, { children: calculateText(d.content, findXPos(d, i, offVisDH.length), offVisDH.length, d.type) }), void 0), dataHunch: d }, "".concat(d.id, "-text")));
