...
var DataHunchIndicator = function (_a) {
    ...
    return (_jsxs("g", { children: [inVisDH.map(function (d, i) {
                ...
                if (inVisDH.length > 3) {
                    return (_jsx(DHIndicatorRect, { onMouseOver: function () { store.setHighlightedDH(d.id); }, x: honrizontalBandScale(d.label) || 0, width: honrizontalBandScale.bandwidth(), y: calculateY(d, true) }, d.id));
                }
                else {
