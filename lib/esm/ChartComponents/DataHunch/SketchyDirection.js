...
var SketchyDirection = function (_a) {
    ...
    return (_jsx(StyledTooltip, { dataHunch: dataHunch, childrenComponent: _jsx("g", { display: store.needToShowPreview ? 'none' : undefined, ref: dhRef, cursor: 'pointer', onClick: function () { store.setSelectedDH([dataHunch.id]); }, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); } }, void 0) }, void 0));
};
