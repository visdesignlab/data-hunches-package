...
var ExclusionIndicator = function (_a) {
    ...
    return (_jsx(StyledTooltip, { dataHunch: dataHunch, childrenComponent: _jsxs("g", { children: [dataHunch.upvotes + dataHunch.downvotes > 0 ? _jsx(ShowUpvotesDownvotes, { xPos: centerX + 20, yPos: centerY - 20, dataHunch: dataHunch }, void 0) : _jsx(_Fragment, {}, void 0), _jsx("g", { ref: dhRef, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () {
                        store.setHighlightedDH(-1);
                    }, onContextMenu: function (e) {
                        toVoteDH(e, store.svgWidth, store.svgHeight);
                        store.setVotingDH(dataHunch);
                    }, onClick: function () { store.setSelectedDH([dataHunch.id]); }, cursor: 'pointer' }, void 0)] }, void 0) }, void 0));
};
