...
var ExclusionIndicator = function (_a) {
    ...
    return (_jsx(LightTooltip, __assign({ title: dataHunch.reasoning }, { children: _jsx("g", { ref: dhRef, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () {
