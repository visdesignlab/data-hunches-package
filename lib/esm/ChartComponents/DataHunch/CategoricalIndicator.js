...
var CategoricalIndicator = function (_a) {
    ...
    return (_jsx(StyledTooltip, { dataHunch: dataHunch, childrenComponent: _jsxs("g", __assign({ display: store.needToShowPreview ? 'none' : undefined }, { children: [dataHunch.upvotes + dataHunch.downvotes > 0 ? _jsx(ShowUpvotesDownvotes, { xPos: xPos + width, yPos: yPos, dataHunch: dataHunch }, void 0) : _jsx(_Fragment, {}, void 0), _jsx("g", { ref: dhRef }, void 0), _jsx("rect", { x: xPos, y: yPos, width: width, height: height, opacity: 0, fill: 'white', cursor: 'pointer', onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); }, onClick: function () { store.setSelectedDH([dataHunch.id]); }, onContextMenu: function (e) {
