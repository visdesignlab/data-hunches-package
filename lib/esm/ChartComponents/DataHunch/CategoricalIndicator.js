...
var CategoricalIndicator = function (_a) {
    var dataHunch = _a.dataHunch, xPos = _a.xPos, yPos = _a.yPos, width = _a.width, height = _a.height, highlighted = _a.highlighted, selected = _a.selected;
    ...
    useLayoutEffect(function () {
        if (dhRef.current !== null) {
            ...
            var sketchyDH = rc.rectangle(xPos, yPos, width, height, {
                fillStyle: 'zigzag',
                fill: categoricalScale(dataHunch.content),
                stroke: 'white',
                fillWeight: 10,
                hachureAngle: 20,
                hachureGap: 18,
