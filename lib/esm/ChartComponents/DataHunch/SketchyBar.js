...
var SketchyBar = function (_a) {
    ...
    return (_jsx(StyledTooltip, { dataHunch: dataHunch, childrenComponent: _jsxs("g", __assign({ display: store.needToShowPreview ? 'none' : undefined }, { children: [_jsx("g", { ref: dhRef }, void 0), _jsxs("g", { children: [_jsx("rect", { x: xPos, y: yPos, width: width, height: height, opacity: 0, fill: 'white', cursor: 'pointer', onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); }, onClick: function () { store.setSelectedDH([dataHunch.id]); }, onContextMenu: function (e) {
