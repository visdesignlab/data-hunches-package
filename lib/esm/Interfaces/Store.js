        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.inputMode = 'none';
                        databaseRef = collection(firebaseSetup, this.datasetName, "sub".concat(this.currentVol), 'dhs');
                        return [4 /*yield*/, updateDoc(doc(collection(firebaseSetup, this.datasetName), "sub".concat(this.currentVol)), { nextIndex: this.nextIndex + 1 })];
                    case 1:
                        _a.sent();
