...
var RootStore = /** @class */ (function () {
    function RootStore() {
        var URLInput = new URL(window.location.href);
        var dataSetTag = URLInput.searchParams.get("data") || '';
        var volTag = parseInt(URLInput.searchParams.get("vol") || '') || 1;
    ...
    RootStore.prototype.setDBTag = function (input) {
        this.dbTag = input;
        this.currentVol = 1;
    };
    ...
    RootStore.prototype.setVotingDH = function (input) {
        this.votingDH = input;
        if (this.selectedDP) {
            this.selectedDP = undefined;
        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.inputMode = 'none';
                        if (!!DataPreset[this.dbTag].lock.includes(this.currentVol)) return [3 /*break*/, 3];
                        databaseRef = collection(firebaseSetup, this.dbTag, "sub".concat(this.currentVol), 'dhs');
                        return [4 /*yield*/, updateDoc(doc(collection(firebaseSetup, this.dbTag), "sub".concat(this.currentVol)), { nextIndex: this.nextIndex + 1 })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, setDoc(doc(databaseRef, this.nextIndex.toString()), dataHunchToSubmit)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
    ...
    RootStore.prototype.setShowCategory = function (input) {
