export declare const useStyles: (props?: any) => import("@material-ui/styles").ClassNameMap<"table" | "rightToolbar" | "menuButton" | "foreignObjectContainer" | "radioStyle" | "catText" | "colorBox">;
interface FontProps {
