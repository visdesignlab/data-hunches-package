...
var PreviewResetButtons_1 = require("../ChartComponents/Forms/PreviewResetButtons");
var __1 = require("..");
var Table = function (_a) {
    ...
    var rowHoverHandler = function (dataHunch) {
        ...
        if (dataHunch.type === 'exclusion') {
            ...
            (0, PreviewResetButtons_1.handlePreviewOnClick)(dataSet, dataHunch.label, undefined, store.svgHeight, store.svgWidth, store.containCategory, store.selectedDP);
        }
    };
