...
var Table = function (_a) {
    ...
    var deleteDHHandler = function (e) {
        if (e.field === 'delete' && e.value === 'x') {
            ...
            (0, lite_1.deleteDoc)((0, lite_1.doc)(Constants_1.firebaseSetup, store.datasetName, "sub".concat(store.currentVol), 'dhs', e.row.id.toString())).then(function (output) {
                store.setTotalDH(store.numOfDH - 1);
            }).catch(function (error) { console.log(error); });
        }
    };
    return ((0, jsx_runtime_1.jsx)("div", __assign({ style: { height: '80vh', overflow: 'auto' } }, { children: (0, jsx_runtime_1.jsx)(data_grid_1.DataGrid, { className: styles.table, onRowEnter: function (d) { rowHoverHandler(d.row); }, onRowOut: rowOutHandler, columns: columns, checkboxSelection: true, onSelectionModelChange: function (d) { store.setSelectedDH(d); }, onCellClick: deleteDHHandler, rows: dhWithDelete }, void 0) }), void 0));
};
