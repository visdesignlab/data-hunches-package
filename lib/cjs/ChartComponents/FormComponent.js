...
var DataSpaceForm_1 = __importDefault(require("./DataSpaceForm"));
var ManipulationForm_1 = __importDefault(require("./ManipulationForm"));
var RatingForm_1 = __importDefault(require("./RatingForm"));
var FormComponent = function (_a) {
    ...
    var formContent = {
        ...
        dataSpace: (0, jsx_runtime_1.jsx)(DataSpaceForm_1.default, { isIncExc: !store.selectedDP }, void 0),
        manipulation: (0, jsx_runtime_1.jsx)(ManipulationForm_1.default, { manipulationOutput: manipulationOutput }, void 0)
    };
