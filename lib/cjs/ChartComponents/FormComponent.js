...
var FormComponent = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("foreignObject", __assign({ id: 'form-component', display: !['none', 'manipulations', 'sketch'].includes(store.inputMode) ? undefined : 'none', width: Constants_1.DefaultForeignObjectWidth, height: Constants_1.DefaultForeignObjectHeight }, { children: formContent[store.inputMode] }), void 0));
};
