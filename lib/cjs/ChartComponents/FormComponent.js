...
var ManipulationForm_1 = __importDefault(require("./Forms/ManipulationForm"));
...
var FormComponent = function () {
    ...
    var formContent = {
        ...
        'data space': (0, jsx_runtime_1.jsx)(DataSpaceForm_1.default, { isInc: store.inputMode === 'inclusion' }, void 0),
        ...
        exclusion: (0, jsx_runtime_1.jsx)(ManipulationForm_1.default, { manipulationOutput: store.selectedDP ? store.selectedDP : '', type: 'exclusion' }, void 0)
    };
    return ((0, jsx_runtime_1.jsx)("foreignObject", __assign({ id: 'form-component', display: !['none', 'manipulations', 'sketch', 'range'].includes(store.inputMode) ? undefined : 'none', width: Constants_1.DefaultForeignObjectWidth, height: Constants_1.DefaultForeignObjectHeight }, { children: formContent[store.inputMode] }), void 0));
};
