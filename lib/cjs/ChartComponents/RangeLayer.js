...
var RangeLayer = function (_a) {
    ...
    var sketchyOption = __assign(__assign({}, Constants_1.DefaultSketchyOptions), { fill: Constants_1.BrightOrange, stroke: Constants_1.BrightOrange });
    ...
    var dragHandler = function (e) {
        ...
        if (isMouseDown) {
            ...
            if (resultRef.current !== null) {
                ...
                var sketchyRec = rc.rectangle(xPos || 0, bandScale(store.selectedDP || '') || 0, Math.abs(pointerStartX - (0, d3_selection_1.pointer)(e)[0]), bandScale.bandwidth(), sketchyOption);
