...
var DHIndicatorRect = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: dataHunch.reasoning }, { children: (0, jsx_runtime_1.jsx)("g", { display: store.needToShowPreview ? 'none' : undefined, ref: dhRef, onMouseOver: function () { store.setSelectedDH([dataHunch.id]); store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () {
