...
var OverAxisIndicator = function (_a) {
    ...
    (0, react_1.useEffect)(function () {
        if (store.selectedDH === dataHunch.id) {
            ...
            setNeedReset(true);
            (0, PreviewReset_1.handlePreviewOnClick)(dataSet, dataHunch.label, parseFloat(dataHunch.content), store.svgHeight, store.svgWidth, store.containCategory.length > 0);
        }
