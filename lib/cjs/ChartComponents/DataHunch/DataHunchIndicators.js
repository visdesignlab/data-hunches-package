...
var DataHunchIndicator = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [inVisDH.map(function (d, i) {
                ...
                if (inVisDH.length > 3) {
                    return ((0, jsx_runtime_1.jsx)(StyledComponents_1.DHIndicatorRect, { display: store.needToShowPreview ? 'none' : undefined, onMouseOver: function () { store.setSelectedDH([d.id]); store.setHighlightedDH(d.id); }, x: honrizontalBandScale(d.label) || 0, width: honrizontalBandScale.bandwidth(), y: calculateY(d, true) }, "".concat(d.id, "-dhindicatorRect")));
                }
                else {
