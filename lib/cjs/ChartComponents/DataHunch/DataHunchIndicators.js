...
var DataHunchIndicator = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [inVisDH.map(function (d, i) {
                ...
                (0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)("text", __assign({ x: valueScale(dataPoint.value) + 7, y: (bandScale(dataPoint.label) || 0) + 0.75 * bandScale.bandwidth() - 2, textAnchor: "middle", fontSize: "smaller", alignmentBaseline: "hanging" }, { children: dataPoint.value }), void 0), aboveAxisDH.map(function (dataHunch, i) {
