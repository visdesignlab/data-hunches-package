...
var SketchyDirection_1 = __importDefault(require("./SketchyDirection"));
...
var DataHunchIndicator = function (_a) {
    ...
    var _f = (0, react_1.useState)([]), directionDH = _f[0], setDirectionDH = _f[1];
    (0, react_3.useEffect)(function () {
        ...
        (0, StateChecker_1.stateUpdateWrapperUseJSON)(directionDH, tempDirectionDH, setDirectionDH);
    }, [dataHunchArray]);
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [inVisDH.map(function (d, i) {
            ...
            }), directionDH.map(function (d, i) {
                return ((0, jsx_runtime_1.jsx)(SketchyDirection_1.default, { dataHunch: d, highlighted: d.id === store.highlightedDH, selected: store.selectedDH.includes(d.id), xPos: valueScale(dataPoint.value), yPos: (bandScale(dataPoint.label) || 0) + bandScale.bandwidth() / directionDH.length * (i + 0.5) }, "sketchy-".concat(d.id)));
