...
var SketchyPolygon = function (_a) {
    var dataHunch = _a.dataHunch, points = _a.points, fill = _a.fill, opacity = _a.opacity, highlighted = _a.highlighted;
    ...
    (0, react_1.useLayoutEffect)(function () {
        if (dhRef.current !== null) {
            if (highlighted) {
                (0, d3_selection_1.select)(dhRef.current).selectAll("path[stroke='white']").attr('stroke', Constants_1.BrightOrange);
            }
            else {
                (0, d3_selection_1.select)(dhRef.current).selectAll("path[stroke='#eb9800']").attr('stroke', "white");
            }
        }
    }, [highlighted]);
    return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: dataHunch.reasoning }, { children: (0, jsx_runtime_1.jsx)("g", { ref: dhRef, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); }, onClick: function () { store.setSelectedDH([dataHunch.id]); }, opacity: opacity, cursor: 'pointer' }, void 0) }), void 0));
};
