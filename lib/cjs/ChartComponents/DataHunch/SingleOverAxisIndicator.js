...
var SingleOverAxisIndicator = function (_a) {
    ...
    (0, react_1.useLayoutEffect)(function () {
        if (curveRef.current !== null) {
            ...
            var roughArrow = rc.polygon(JSON.parse(arrowPoints), __assign(__assign({}, Constants_1.DefaultSketchyOptions), { fillStyle: 'solid' }));
    ...
    (0, react_1.useLayoutEffect)(function () {
        if (curveRef.current !== null) {
            if (highlighted) {
                ...
                (0, d3_selection_1.select)(curveRef.current).selectAll('path').attr('stroke', Constants_1.DarkGray);
            }
        }
    }, [highlighted, selected]);
    return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: dataHunch.reasoning }, { children: (0, jsx_runtime_1.jsxs)("g", __assign({ cursor: "pointer", onClick: function () { store.setSelectedDH([dataHunch.id]); }, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () { store.setHighlightedDH(-1); } }, { children: [(0, jsx_runtime_1.jsx)("g", { ref: curveRef }, void 0), (0, jsx_runtime_1.jsx)("text", __assign({ textAnchor: "middle", alignmentBaseline: "hanging", fill: highlighted ? Constants_1.HighlightColor : (selected ? Constants_1.SelectionColor : Constants_1.DarkGray), x: textX, y: textY, fontFamily: "'Nanum Brush Script', cursive", fontWeight: "bold" }, { children: dataHunch.content }), void 0)] }), void 0) }), void 0));
};
