...
var CategoricalIndicator = function (_a) {
    ...
    return (dataHunchArray.length > 0 ?
        (0, jsx_runtime_1.jsx)("g", { children: polygonPoints.map(function (d, i) {
                return (0, jsx_runtime_1.jsx)("polygon", { points: makePointArray(d), fill: chooseFill(i)[0].toString(), strokeOpacity: 0.2, 
                    // opacity={chooseFill(i)[1]}
                    opacity: 1, strokeWidth: 2, stroke: 'white' }, "polygon-".concat(i));
