...
var CategoricalIndicator = function (_a) {
    ...
    return (dataHunchArray.length > 0 ?
        (0, jsx_runtime_1.jsx)("g", { children: polygonPoints.map(function (d) {
                return (0, jsx_runtime_1.jsx)("polygon", { points: makePointArray(d), fill: chooseFill()[0].toString(), strokeOpacity: 0.2, opacity: chooseFill()[1], stroke: Constants_1.DarkGray }, void 0);
