...
var SketchyBar = function (_a) {
    var xPos = _a.xPos, yPos = _a.yPos, width = _a.width, height = _a.height, dataHunch = _a.dataHunch, highlighted = _a.highlighted, selected = _a.selected;
    ...
    (0, react_1.useLayoutEffect)(function () {
        if (dhRef.current !== null) {
            ...
            var sketchyDH = rc.rectangle(xPos, yPos, width, height, __assign(__assign({}, Constants_1.DefaultSketchyOptions), { fill: Constants_1.DarkGray, stroke: Constants_1.DarkGray }));
    ...
    return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: dataHunch.reasoning }, { children: (0, jsx_runtime_1.jsx)("g", { display: store.needToShowPreview ? 'none' : undefined, ref: dhRef, onMouseOver: function () { store.setHighlightedDH(dataHunch.id); }, onMouseOut: function () {
