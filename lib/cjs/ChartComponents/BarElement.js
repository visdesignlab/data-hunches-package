...
var BarElement = function (_a) {
    ...
    var barElementOnClick = function (e, rightClick) {
        e.preventDefault();
    ...
    return (0, jsx_runtime_1.jsx)("rect", { width: width, height: height, x: xPos, y: yPos, cursor: store.userName ? 'pointer' : undefined, onContextMenu: barElementOnClick, onClick: function (e) { barElementOnClick(e, true); }, 
