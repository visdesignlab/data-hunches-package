...
var BarElement = function (_a) {
    ...
    return (0, jsx_runtime_1.jsx)("rect", { width: width, height: height, x: xPos, y: yPos, cursor: store.selectingADataPoint ? 'pointer' : undefined, onClick: barElementOnClick, onMouseLeave: function () { store.setHighlightedDH(-1); }, fill: store.selectedDP === dataElement.label ? Constants_1.BrightOrange : fill }, void 0);
};
