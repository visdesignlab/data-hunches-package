        ...
        if (inVisDH.length <= 3) {
            if (dhRef.current !== null) {
                ...
                inVisDH.forEach(function (d, i) {
                    console.log(honrizontalBandScale(d.label) || 0 + honrizontalBandScale.bandwidth() / inVisDH.length * i, calculateY(d, false), honrizontalBandScale.bandwidth() / inVisDH.length, calculateHeight(d));
                    var sketchyDH = rc_1.rectangle(honrizontalBandScale(d.label) || 0 + honrizontalBandScale.bandwidth() / inVisDH.length * i, calculateY(d, false), honrizontalBandScale.bandwidth() / inVisDH.length, calculateHeight(d), {
