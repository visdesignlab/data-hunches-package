...
var PreviewResetButtons = function (_a) {
    ...
    var previewHandler = function () {
        ...
        (0, PreviewReset_1.handlePreviewOnClick)(dataSet, labelToPreview, valueToPreview, store.svgHeight, store.svgWidth, store.showCategory, modelInput);
    };
    ...
    return ((0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, { children: [(0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ size: 'small', disabled: disableButtons, onClick: previewHandler }, { children: "Preview" }), void 0), (0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ size: 'small', disabled: disableButtons, onClick: resetHandler }, { children: "Reset" }), void 0)] }, void 0));
};
