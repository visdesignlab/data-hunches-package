...
var PreviewResetButtons = function (_a) {
    ...
    var previewHandler = function () {
        (0, exports.handlePreviewOnClick)(dataSet, labelToPreview, valueToPreview, store.svgHeight, store.svgWidth, store.containCategory, store.selectedDP);
    };
    var resetHandler = function () {
        (0, exports.handleResetOnClick)(dataSet, store.svgHeight, store.svgWidth, store.containCategory, store.selectedDP);
    };
...
var handlePreviewOnClick = function (ogDataSet, labelToPreview, valueToPreview, svgHeight, svgWidth, containCategory, selectedDP) {
    ...
    (0, d3_selection_1.select)('#rectangles-preview')
        ...
        .attr("fill", function (d) { return (0, ScaleGenerator_1.getRectFill)(d, containCategory, selectedDP, categoricalScale); });
    // make new data
...
var handleResetOnClick = function (ogDataSet, svgHeight, svgWidth, containCategory, selectedDP) {
    var verticalScale = (0, ScaleGenerator_1.makeVerticalScale)(ogDataSet, svgHeight);
    var bandScale = (0, ScaleGenerator_1.makeBandScale)(ogDataSet, svgWidth);
    var categoricalScale = (0, ScaleGenerator_1.makeCategoricalScale)(ogDataSet);
