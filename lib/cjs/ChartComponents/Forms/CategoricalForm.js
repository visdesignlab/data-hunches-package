...
var CategoricalForm = function () {
    ...
    (0, react_1.useEffect)(function () {
        ...
        setRatingValue("Cat".concat(tempcatNum));
    ...
    return ((0, jsx_runtime_1.jsxs)(core_1.Container, __assign({ className: styles.foreignObjectContainer }, { children: [(0, jsx_runtime_1.jsxs)(core_1.RadioGroup, __assign({ name: "Rating", onChange: handleRadioChange, value: ratingValue }, { children: [(0, jsx_runtime_1.jsx)(core_1.FormControlLabel, { value: "Cat0", control: (0, jsx_runtime_1.jsx)(core_1.Radio, { size: "small", className: styles.radioStyle }, void 0), label: (0, jsx_runtime_1.jsxs)("div", __assign({ className: styles.catText }, { children: [(0, jsx_runtime_1.jsx)("div", { className: styles.colorBox, style: { backgroundColor: Constants_1.CategoricalColor[0] } }, void 0), catNum === 0 ? 'Original category' : ''] }), void 0) }, void 0), (0, jsx_runtime_1.jsx)(core_1.FormControlLabel, { value: "Cat1", control: (0, jsx_runtime_1.jsx)(core_1.Radio, { size: "small", className: styles.radioStyle }, void 0), label: (0, jsx_runtime_1.jsxs)("div", __assign({ className: styles.catText }, { children: [(0, jsx_runtime_1.jsx)("div", { className: styles.colorBox, style: { backgroundColor: Constants_1.CategoricalColor[1] } }, void 0), catNum === 1 ? 'Original category' : ''] }), void 0) }, void 0), (0, jsx_runtime_1.jsx)(core_1.FormControlLabel, { value: "Cat2", control: (0, jsx_runtime_1.jsx)(core_1.Radio, { size: "small", className: styles.radioStyle }, void 0), label: (0, jsx_runtime_1.jsxs)("div", __assign({ className: styles.catText }, { children: [(0, jsx_runtime_1.jsx)("div", { className: styles.colorBox, style: { backgroundColor: Constants_1.CategoricalColor[2] } }, void 0), catNum === 2 ? 'Original category' : ''] }), void 0) }, void 0)] }), void 0), (0, jsx_runtime_1.jsx)(ReasonConfidenceInput_1.default, { updateConfidenceReason: sendConfidenceReasonToParent }, void 0), (0, jsx_runtime_1.jsx)(SubmitCancelButtons_1.default, { disableSubmit: !ratingValue || reasonInput.length === 0, dhToSubmit: {
                    type: 'categorical',
                    user: store.userName,
