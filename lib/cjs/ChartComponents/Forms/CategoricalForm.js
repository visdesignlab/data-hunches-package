...
var CategoricalForm = function () {
    ...
    var _c = (0, react_1.useState)(3), confidenceInput = _c[0], setConfidenceInput = _c[1];
    var sendConfidenceReasonToParent = function (confidenceValue, reason) {
        setReasonInput(reason);
        setConfidenceInput(confidenceValue);
    };
    return ((0, jsx_runtime_1.jsxs)(core_1.Container, __assign({ className: styles.foreignObjectContainer }, { children: [(0, jsx_runtime_1.jsx)(core_1.RadioGroup, __assign({ name: "Rating", onChange: handleRadioChange, value: ratingValue }, { children: Constants_1.DataPreset[store.dbTag].categories.map(function (d, i) {
                    return (0, jsx_runtime_1.jsx)(core_1.FormControlLabel, { value: d, control: (0, jsx_runtime_1.jsx)(core_1.Radio, { style: { paddingTop: '0px', paddingBottom: '0px' }, size: "small", className: styles.radioStyle }, void 0), label: (0, jsx_runtime_1.jsxs)("div", __assign({ className: styles.catText }, { children: [(0, jsx_runtime_1.jsx)("div", { className: styles.colorBox, style: { backgroundColor: Constants_1.CategoricalColor[i] } }, void 0), d] }), void 0) }, "".concat(d, "-radio"));
