...
var ManipulationLayer = function (_a) {
    ...
    var mouseDownHandler = function (e) {
        if (!isMouseDown && resultRef.current !== null) {
            ...
            var drawingG = resultRef.current;
            var rc = rough.default.svg(drawingG);
            var sketchyRec = rc.rectangle(Constants_1.margin.left, bandScale(store.selectedDP || '') || 0, (0, d3_selection_1.pointer)(e)[0] - Constants_1.margin.left, bandScale.bandwidth(), sketchyOption);
            drawingG.appendChild(sketchyRec);
        }
        setIsMouseDown(true);
        timer0 = (0, d3_timer_1.now)();
    };
    return ((0, jsx_runtime_1.jsxs)("g", __assign({ display: store.inputMode === 'manipulations' ? undefined : 'none' }, { children: [(0, jsx_runtime_1.jsx)("g", { id: 'result-rect', ref: resultRef }, void 0), (0, jsx_runtime_1.jsx)("rect", { id: 'drag-rect', x: Constants_1.margin.left, 
