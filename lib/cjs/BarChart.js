...
var BarChart = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [(0, jsx_runtime_1.jsx)(ChartLegends_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)("g", __assign({ id: 'chart-title' }, { children: [(0, jsx_runtime_1.jsx)("text", __assign({ x: store.svgWidth * 0.5, y: store.svgHeight - Constants_1.margin.bottom, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                                return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: d.reasoning }, { children: (0, jsx_runtime_1.jsx)(StyledComponents_1.DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, x: (store.svgWidth - Constants_1.margin.left - Constants_1.margin.right) / 2 * (i % 2), y: store.svgHeight - Constants_1.margin.bottom + 30 + Math.floor(i / 2) * (Constants_1.IndicatorSpace + Constants_1.IndicatorSize), fontSize: 'larger' }, { children: "* ".concat(d.content.length > 25 ? "".concat(d.content.slice(0, 25), "...") : d.content) }), "".concat(d.id, "-text")) }), void 0));
