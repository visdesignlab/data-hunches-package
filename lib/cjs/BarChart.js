...
var BarChart = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(GeneralControl_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [(0, jsx_runtime_1.jsxs)("g", __assign({ id: 'chart-title' }, { children: [(0, jsx_runtime_1.jsx)("text", __assign({ x: store.svgWidth * 0.5, y: 5, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                                return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: d.content }, { children: (0, jsx_runtime_1.jsx)(StyledComponents_1.DHIndicatorText, __assign({ x: findStart() + Constants_1.IndicatorSize * (i) * 2 + Constants_1.IndicatorSpace * i, y: 34, fontSize: 'large' }, { children: "*" }), d.id) }), d.id));
                            })] }), void 0), (0, jsx_runtime_1.jsx)("g", { className: 'axis', id: "band-axis" }, void 0), (0, jsx_runtime_1.jsx)("g", __assign({ id: "rectangles-preview", display: (store.inputMode === 'dataSpace' || store.needToShowPreview) ? undefined : 'none' }, { children: (0, jsx_runtime_1.jsx)("g", { className: 'axis', id: "axis-mask", transform: "translate(".concat(Constants_1.margin.left, ",0)") }, void 0) }), void 0), (0, jsx_runtime_1.jsx)("g", { className: 'axis', id: "vertical-axis" }, void 0), (0, jsx_runtime_1.jsx)("g", __assign({ id: "rectangles", display: (store.inputMode !== 'dataSpace' && !store.needToShowPreview) ? undefined : 'none' }, { children: dataSet.map(function (d, i) {
                        ...
                        }) }), void 0), (0, jsx_runtime_1.jsx)("g", __assign({ id: 'data-hunches-container' }, { children: dataSet.map(function (d) {
                            if (d.dataHunchArray) {
                                if (store.highlightedDH === -1) {
                                    return (0, jsx_runtime_1.jsx)(DataHunchIndicators_1.default, { dataHunchArray: d.dataHunchArray }, d.label);
                                }
                                else {
                                    return (0, jsx_runtime_1.jsx)(DataHunchIndicators_1.default, { dataHunchArray: d.dataHunchArray.filter(function (d) { return d.id === store.highlightedDH; }) }, d.label);
                                }
                            }
                            else {
