...
var BarChart = function (_a) {
    var dataHunchArray = _a.dataHunchArray, datasetExplanation = _a.datasetExplanation;
    ...
    (0, d3_selection_1.select)('#band-axis')
        ...
        .selectAll(".tick text")
        .call(wrap);
    return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [(0, jsx_runtime_1.jsx)(ChartLegends_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)("g", __assign({ id: 'chart-title' }, { children: [(0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: datasetExplanation }, { children: (0, jsx_runtime_1.jsxs)("text", __assign({ x: store.svgWidth * 0.5, y: store.svgHeight - Constants_1.margin.bottom, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: [store.datasetName, datasetExplanation.length > 0 ? '*' : ''] }), void 0) }), void 0), allChartDHArray.map(function (d, i) {
                                return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("p", { children: ["Content: ", d.content] }, void 0), (0, jsx_runtime_1.jsxs)("p", { children: ["Reasoning: ", d.reasoning] }, void 0)] }, void 0) }, { children: (0, jsx_runtime_1.jsx)(StyledComponents_1.DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, isSelected: store.selectedDH.includes(d.id), onClick: function () { store.setSelectedDH([d.id]); }, x: (store.svgWidth - Constants_1.margin.left - Constants_1.margin.right) / 2 * (i % 2), y: store.svgHeight - Constants_1.margin.bottom + 30 + Math.floor(i / 2) * (Constants_1.IndicatorSpace + Constants_1.IndicatorSize), fontSize: 'larger' }, { children: "* ".concat(d.content.length > 25 ? "".concat(d.content.slice(0, 25), "...") : d.content) }), "".concat(d.id, "-text")) }), void 0));
                            ...
                            return (0, jsx_runtime_1.jsx)(BarElement_1.default, { dataElement: d, width: valueScale(d.value) - Constants_1.margin.left, height: bandScale.bandwidth(), xPos: Constants_1.margin.left, yPos: bandScale(d.label) || 0, fill: store.containCategory.length > 0 ? categoricalColorScale(d.categorical || 'a') : Constants_1.DarkBlue }, "".concat(i, "-barelement"));
                        ...
                        }) }), void 0), store.inputMode === 'range' ? (0, jsx_runtime_1.jsx)(RangeLayer_1.default, { sendManipulation: sendManipulationToParent }, void 0) : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}, void 0), store.inputMode === 'manipulations' ? (0, jsx_runtime_1.jsx)(ManipulationLayer_1.default, { sendManipulation: sendManipulationToParent }, void 0) : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}, void 0), store.inputMode === 'sketch' ?
                        (0, jsx_runtime_1.jsx)(SketchLayer_1.default, { sendManipulation: sendManipulationToParent }, void 0) : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}, void 0), (0, jsx_runtime_1.jsx)(FormComponent_1.default, { manipulationOutput: manipulationResult }, void 0), (0, jsx_runtime_1.jsx)(SpecificControl_1.default, {}, void 0)] }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ style: { width: Constants_1.DefaultForeignObjectWidth, height: Constants_1.DefaultForeignObjectHeight } }, { children: (store.inputMode === 'sketch' || store.inputMode === 'manipulations' || store.inputMode === 'range') ?
                    (0, jsx_runtime_1.jsx)(ManipulationForm_1.default, { manipulationOutput: manipulationResult, type: store.inputMode }, void 0) : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}, void 0) }), void 0)] }, void 0);
};
