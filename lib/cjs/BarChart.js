...
var BarChart = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(GeneralControl_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [(0, jsx_runtime_1.jsxs)("g", __assign({ id: 'chart-title' }, { children: [(0, jsx_runtime_1.jsx)("text", __assign({ x: store.svgWidth * 0.5, y: 5, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                                return ((0, jsx_runtime_1.jsx)(core_1.Tooltip, __assign({ title: d.content }, { children: (0, jsx_runtime_1.jsx)(StyledComponents_1.DHIndicatorText, __assign({ isHighlighted: d.id === store.highlightedDH, x: findStart() + Constants_1.IndicatorSize * (i) * 2 + Constants_1.IndicatorSpace * i, y: 34, fontSize: 'large' }, { children: "*" }), d.id) }), d.id));
                            ...
                            if (barDP.dataHunchArray) {
                                var nonCatDH = barDP.dataHunchArray.filter(function (d) { return d.type !== 'categorical'; });
                                var catDH = barDP.dataHunchArray.filter(function (d) { return d.type === 'categorical'; });
                                if (store.selectedDH === -1) {
                                    var categoricalArray = catDH.map(function (d) {
                                        return (0, jsx_runtime_1.jsx)(CategoricalIndicator_1.default, { dataHunch: d }, void 0);
                                    });
                                    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: __spreadArray([(0, jsx_runtime_1.jsx)(DataHunchIndicators_1.default, { dataHunchArray: nonCatDH }, barDP.label)], categoricalArray, true) }, void 0));
                                }
                                else {
                                    var categoricalArray = catDH.filter(function (d) { return d.id === store.selectedDH; }).map(function (d) {
                                        return (0, jsx_runtime_1.jsx)(CategoricalIndicator_1.default, { dataHunch: d }, void 0);
                                    });
                                    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: __spreadArray([(0, jsx_runtime_1.jsx)(DataHunchIndicators_1.default, { dataHunchArray: nonCatDH.filter(function (d) { return ["annotation", 'exclusion'].includes(d.type) || d.id === store.selectedDH; }) }, barDP.label)], categoricalArray, true) }, void 0));
                                }
                            }
                            else {
