    ...
    return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(GeneralControl_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)("svg", __assign({ width: store.svgWidth, height: store.svgHeight }, { children: [(0, jsx_runtime_1.jsx)(ChartLegends_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)("g", __assign({ id: 'chart-title' }, { children: [(0, jsx_runtime_1.jsx)("text", __assign({ x: store.svgWidth * 0.5, y: 5, alignmentBaseline: 'hanging', textAnchor: "middle", fontSize: 'large' }, { children: store.datasetName }), void 0), allChartDHArray.map(function (d, i) {
                            ...
                            if (barDP.dataHunchArray) {
                                ...
                                if (store.selectedDH === -1) {
                                    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(DataHunchIndicators_1.default, { dataHunchArray: barDP.dataHunchArray }, barDP.label), (0, jsx_runtime_1.jsx)(CategoricalIndicator_1.default, { dataHunchArrayString: JSON.stringify(catDH) }, barDP.label)] }, void 0));
                                }
                                else {
                                    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(DataHunchIndicators_1.default, { dataHunchArray: barDP.dataHunchArray.filter(function (d) { return ["annotation", 'exclusion', 'categorical'].includes(d.type) || d.id === store.selectedDH; }) }, barDP.label), (0, jsx_runtime_1.jsx)(CategoricalIndicator_1.default, { dataHunchArrayString: JSON.stringify(catDH.filter(function (d) { return d.id === store.selectedDH; })) }, barDP.label)] }, void 0));
                                }
                            }
                            else {
