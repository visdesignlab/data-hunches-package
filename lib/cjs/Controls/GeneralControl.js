...
var GeneralControl = function () {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, __assign({ color: "primary", "aria-label": "outlined primary button group", disabled: !store.userName, size: 'small' }, { children: [(0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: onClickSelectADataPoint }, { children: "Select a Data Point" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: onClickAnnotation }, { children: "Add Annotations" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: onClickIncExc }, { children: "Inclusion / Exclusion" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: onClickModelInput }, { children: "Model Input" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: onClickGraphical }, { children: "Graphical Annotations" }), void 0)] }), void 0) }, void 0));
};
