...
var GeneralControl = function () {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, __assign({ color: "primary", "aria-label": "outlined primary button group", disabled: !store.userName, size: 'small' }, { children: [(0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('annotation'); } }, { children: "Add Annotations" }), void 0), (0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('data space'); } }, { children: "Inclusion" }), void 0), (0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('model'); } }, { children: "Model Input" }), void 0), (0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ onClick: function () { dhButtonClickHandler('sketch'); } }, { children: "Graphical Annotations" }), void 0)] }), void 0) }, void 0));
};
