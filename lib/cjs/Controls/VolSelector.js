...
var VolSelector = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, __assign({ style: { paddingRight: '5px' } }, { children: [(0, jsx_runtime_1.jsx)(core_1.Button, __assign({ size: 'small', variant: "outlined", onClick: handleDBMenu, color: "primary" }, { children: "Select Data" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ size: 'small', variant: "outlined", onClick: handleVolMenu, color: "primary" }, { children: "Select Vol" }), void 0), (0, jsx_runtime_1.jsxs)(core_1.Menu, __assign({ anchorEl: anchorVol, keepMounted: true, open: Boolean(anchorVol), onClose: handleClose }, { children: [subArray.map(function (d, i) {
