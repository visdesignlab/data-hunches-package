...
var SpecificControl = function () {
    ...
    return ((0, jsx_runtime_1.jsx)("foreignObject", __assign({ id: 'specific-control', 
        ...
        display: 'none', width: Constants_1.ControlFOWidth, height: store.containCategory ? Constants_1.ControlFOHeight : Constants_1.WithoutCatControlFOHeight }, { children: (0, jsx_runtime_1.jsxs)(core_1.Container, __assign({ className: styles.foreignObjectContainer }, { children: [(0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, __assign({ orientation: "vertical", color: "primary", "aria-label": "vertical outlined primary button group" }, { children: [(0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: function () { clickHandler('annotation'); } }, { children: "Annotation" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: function () {
                                clickHandler('range');
                            ...
                            } }, { children: "Exclusion" }), void 0), store.containCategory ? (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: function () {
