...
var SpecificControl = function () {
    ...
    var rangeOnClickHandler = function () {
    ...
    return ((0, jsx_runtime_1.jsx)("foreignObject", __assign({ id: 'specific-control', 
        ...
        display: 'none', width: Constants_1.ControlFOWidth, height: store.containCategory ? Constants_1.ControlFOHeight : Constants_1.WithoutCatControlFOHeight }, { children: (0, jsx_runtime_1.jsxs)(core_1.Container, __assign({ className: styles.foreignObjectContainer }, { children: [(0, jsx_runtime_1.jsxs)(core_1.ButtonGroup
                ...
                , __assign({ 
                    // ref={divRef}
                    orientation: "vertical", color: "primary", "aria-label": "vertical outlined primary button group" }, { children: [(0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: annotationOnClickHandler }, { children: "Annotation" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: rangeOnClickHandler }, { children: "Range" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: manipulationOnClickHandler }, { children: "Manipulation" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: ratingClickHandler }, { children: "Rating" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: dataSpaceClickHandler }, { children: "Data Space" }), void 0), store.containCategory ? (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ onClick: categoricalClickHandler }, { children: "Categorical" }), void 0) : (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}, void 0)] }), void 0), (0, jsx_runtime_1.jsx)(core_1.IconButton, __assign({ size: "small", onClick: function () {
