...
var DemoOptionButtons = function () {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, __assign({ style: { paddingRight: '5px' } }, { children: [(0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ size: 'small', variant: "outlined", color: "primary", onClick: handleDBMenu }, { children: "Select Data" }), void 0), (0, jsx_runtime_1.jsx)(StyledComponents_1.NonCapButton, __assign({ size: 'small', variant: "outlined", onClick: handleVolMenu, color: "primary" }, { children: "Select Vol" }), void 0), Constants_1.DataPreset[store.dbTag].categories ?
