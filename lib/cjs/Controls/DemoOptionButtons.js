...
var DemoOptionButtons = function () {
    ...
    var _b = (0, react_1.useState)(null), anchorVol = _b[0], setAnchorVol = _b[1];
    var _c = (0, react_1.useState)(null), anchorDB = _c[0], setAnchorDB = _c[1];
    var _d = (0, react_1.useState)([]), subArray = _d[0], setSubArray = _d[1];
    var handleVolMenu = function (event) {
        setAnchorVol(event.currentTarget);
    };
    var handleDBMenu = function (event) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(core_1.ButtonGroup, __assign({ style: { paddingRight: '5px' } }, { children: [(0, jsx_runtime_1.jsx)(core_1.Button, __assign({ size: 'small', variant: "outlined", color: "primary", onClick: handleDBMenu }, { children: "Select Data" }), void 0), (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ size: 'small', variant: "outlined", onClick: handleVolMenu, color: "primary" }, { children: "Select Vol" }), void 0), Constants_1.DataPreset[store.dbTag].categories ?
                        (0, jsx_runtime_1.jsx)(core_1.Button, __assign({ size: 'small', variant: 'outlined', color: store.showCategory ? 'primary' : 'default', onClick: function () {
                                store.setShowCategory(!store.showCategory);
                            } }, { children: "Show Category" }), void 0) :
                        (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}, void 0), (0, jsx_runtime_1.jsxs)(core_1.Menu, __assign({ anchorEl: anchorVol, keepMounted: true, open: Boolean(anchorVol), onClose: handleClose }, { children: [subArray.map(function (d, i) {
                            ...
                            }), (0, jsx_runtime_1.jsxs)(core_1.MenuItem, __assign({ onClick: function () { sendDialogSignal(true); } }, { children: [(0, jsx_runtime_1.jsx)(Add_1.default, {}, void 0), "Start new volume"] }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)(core_1.Menu, __assign({ anchorEl: anchorDB, keepMounted: true, open: Boolean(anchorDB), onClose: handleClose }, { children: Object.keys(Constants_1.DataPreset).map(function (d) {
                            return ((0, jsx_runtime_1.jsx)(core_1.MenuItem, __assign({ onClick: function () {
                                    store.setDBTag(d);
                                    handleClose();
                                } }, { children: Constants_1.DataPreset[d].name }), "SelectDB".concat(d)));
                        }) }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)(NewVolDialog_1.default, { open: openDialog, sendCloseSignal: sendDialogSignal }, void 0)] }, void 0));
};
