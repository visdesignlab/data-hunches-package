...
var TopBar = function () {
    ...
    return (0, jsx_runtime_1.jsx)(core_1.AppBar, __assign({ position: "static", color: "transparent", elevation: 2, style: { zIndex: 3 } }, { children: (0, jsx_runtime_1.jsxs)(core_1.Toolbar, { children: [(0, jsx_runtime_1.jsx)(core_1.Typography, __assign({ variant: "h6" }, { children: "Data Hunch Demo" }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: styles.rightToolbar }, { children: store.userName ?
                        (0, jsx_runtime_1.jsxs)(core_1.Button, __assign({ onClick: handleMenu, variant: "outlined", color: "primary" }, { children: ["Signed in as ".concat(store.userName), (0, jsx_runtime_1.jsx)(AccountCircle_1.default, {}, void 0)] }), void 0) :
                        (0, jsx_runtime_1.jsx)(react_google_login_1.GoogleLogin, { clientId: "565250402151-jseb9mfqk3tumg1q6vcgklmovro4h9b4.apps.googleusercontent.com", render: function (renderProps) { return ((0, jsx_runtime_1.jsxs)(core_1.Button, __assign({ onClick: renderProps.onClick, variant: "outlined", color: "primary", disabled: renderProps.disabled }, { children: ["Sign in with Google to continue", (0, jsx_runtime_1.jsx)(AccountCircle_1.default, {}, void 0)] }), void 0)); }, buttonText: "Login", onSuccess: responseGoogle, onFailure: function () { console.log('failed'); }, cookiePolicy: 'single_host_origin', isSignedIn: true }, void 0) }), void 0), (0, jsx_runtime_1.jsxs)(core_1.Menu, __assign({ id: "menu-appbar", anchorEl: anchorEl, keepMounted: true, open: open, onClose: handleClose }, { children: [(0, jsx_runtime_1.jsx)(react_google_login_1.GoogleLogin, { clientId: "565250402151-jseb9mfqk3tumg1q6vcgklmovro4h9b4.apps.googleusercontent.com", render: function (renderProps) { return ((0, jsx_runtime_1.jsx)(core_1.MenuItem, __assign({ onClick: function () {
                                    handleClose();
                                    renderProps.onClick();
