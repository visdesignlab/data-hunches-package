...
var NewVolDialog = function (_a) {
    ...
    var confirmVol = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    attrRef = (0, lite_1.doc)(Constants_1.firebaseSetup, store.dbTag, 'attr');
                    return [4 /*yield*/, (0, lite_1.getDoc)(attrRef)];
                case 1:
                    attrResult = _a.sent();
                    if (!attrResult.exists()) return [3 /*break*/, 4];
                    numberOfSubs = attrResult.data().subs;
                    return [4 /*yield*/, (0, lite_1.updateDoc)((0, lite_1.doc)(Constants_1.firebaseSetup, store.dbTag, 'attr'), {
                            subs: numberOfSubs + 1
                        })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, lite_1.setDoc)((0, lite_1.doc)((0, lite_1.collection)(Constants_1.firebaseSetup, store.dbTag), "sub".concat(numberOfSubs + 1)), { name: volName })];
                case 3:
                    _a.sent();
