            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, lite_1.updateDoc)((0, lite_1.doc)((0, lite_1.collection)(Constants_1.firebaseSetup, this.datasetName), "sub".concat(this.currentVol)), { nextIndex: this.nextIndex + 1 })];
                    case 1:
                        _a.sent();
