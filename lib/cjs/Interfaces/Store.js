        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.inputMode = 'none';
                        databaseRef = (0, lite_1.collection)(Constants_1.firebaseSetup, this.dbTag, "sub".concat(this.currentVol), 'dhs');
                        return [4 /*yield*/, (0, lite_1.updateDoc)((0, lite_1.doc)((0, lite_1.collection)(Constants_1.firebaseSetup, this.dbTag), "sub".concat(this.currentVol)), { nextIndex: this.nextIndex + 1 })];
                    case 1:
                        _a.sent();
