...
var getRectFill = function (d, containCategory, selectedDP, categoricalScale) {
    if (d.label === selectedDP) {
        return Constants_1.BrightOrange;
    }
    return containCategory ? (categoricalScale(d.categorical) || Constants_1.DarkBlue) : Constants_1.DarkBlue;
};
