...
var handlePreviewOnClick = function (ogDataSet, labelToPreview, valueToPreview, svgHeight, svgWidth, containCategory) {
    ...
    (0, d3_selection_1.select)('#rectangles-preview')
        ...
        .attr("fill", function (d) { return (0, ScaleGenerator_1.getRectFill)(d, containCategory, labelToPreview, categoricalScale); });
    // make new data
