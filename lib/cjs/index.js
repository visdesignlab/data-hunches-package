...
var BarChartWithDH = function (_a) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        (0, lite_1.getDoc)((0, lite_1.doc)(Constants_1.firebaseSetup, store.datasetName, "sub".concat(store.currentVol))).then(function (dhNextIndex) {
        ...
        (0, lite_1.getDocs)((0, lite_1.collection)(Constants_1.firebaseSetup, store.datasetName, "sub".concat(store.currentVol), 'dhs')).then(function (dhResult) {
