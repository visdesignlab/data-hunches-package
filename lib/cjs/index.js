...
var BarChartWithDH = function () {
    ...
    var _a = (0, react_1.useState)([]), improvedDataSet = _a[0], setImprovedDataSet = _a[1];
    ...
    var _b = (0, react_1.useState)([]), savedDH = _b[0], setSavedDH = _b[1];
    (0, react_1.useEffect)(function () {
